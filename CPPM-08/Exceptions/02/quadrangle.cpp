...
Quadrangle::Quadrangle(int a, int b, int c, int d, int A, int B, int C, int D) : Figure{ 4, "Четырёхугольник" }, a{ a }, b{ b }, c{ c }, d{ d }, A{ A }, B{ B }, C{ C }, D{ D } { check(); }
Quadrangle::Quadrangle(int a, int b, int c, int d, int A, int B, int C, int D, std::string_view name) : Figure{ 4, name }, a{ a }, b{ b }, c{ c }, d{ d }, A{ A }, B{ B }, C{ C }, D{ D } { check(); }
